...
![A schematic diagram of a prony brake[@PronyBrakeSchematic].](../assets/figures/dyno-PronyBrake.svg){width=80% #fig-pronyBrake}
...
![A small prony brake dynamometer[@PronyBrakeYoutube]](../assets/figures/dyno-PronyBrakeYoutube.png){width=60% #fig-pronyBrakeOnYoutube}
...
![A schematic diagram of a eddy current brake[@EddyCurrentBrakeSchematic].](../assets/figures/dyno-EddyCurrentBrake.svg){width=60% #fig-eddyCurrentDiagram}
...
![A schematic diagram of a DC Motor[@DCMotorSchematic].](../assets/figures/dyno-DCMotor.svg){width=80% #fig-DCMotor}
