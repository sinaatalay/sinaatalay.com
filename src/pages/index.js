  ...
  return (
    <Layout title="Home">
      ...
      <main>
        ...
        <p className="pPages">
          In the <Link to="/projects">Projects</Link> section, you can find brief reports of
          projects I have been involved in.
        </p>
        <Seperator />
        <h2 className="h2Pages">About Ionizer</h2>
        <p className="pPages">
          In the spring of 2022, I started to work on an ion truster simulation program (
          <strong>Ionizer</strong>) at{" "}
        ...
        <p className="pPages">
          It's a tricky simulation because the applicability of the continuum assumption is
          questionable since the operating pressures are pretty low. Therefore, the molecular theory
          has to be employed.
        </p>
        <p className="pPages">
          ...
          to calculate the electrostatic field inside the thruster and move the ions accordingly
          with the well-established molecular approach, PIC-DSMC.
        </p>
        <p className="pPages">
        ...
        <p className="pPages">
          In June 2020, I instructed the entire <em>Engineering Mechanics: Dynamics</em> course on
          YouTube, which has so far received more than 200,000 views. You can see two of my videos
          below.
        </p>
