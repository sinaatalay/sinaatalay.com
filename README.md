...
1.  **Open the source code and start editing!**
    ...
    Open the `my-hello-world-starter` directory in your code editor of choice and edit `src/h1Pages/index.js`. Save your changes and the browser will update in real time!
